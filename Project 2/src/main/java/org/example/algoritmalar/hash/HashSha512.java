...
public class HashSha512 extends Hash {

    public static String startSha512Message(String userInputHashMessage, String userInputMatch, String userInputHash) {
        HashSha512 worker = new HashSha512();
    ...
    public String getMessage(String userInputHashMessage) {
        ...
        sha512.update(inputBytesEncrypt, 0, inputBytesEncrypt.length);
        byte[] sha512Bytes = new byte[64];
        sha512.doFinal(sha512Bytes, 0);

        String hexHash = bytesToHex(sha512Bytes);
        return "SHA-512 ile metin hashlendi! " + hexHash;
    }
    ...
    public String matchMessage(String userInputMatch, String userInputHash) {
        ...
        SHA512Digest sha512Match = new SHA512Digest();
        sha512Match.update(inputBytesMatchEncrypt, 0, inputBytesMatchEncrypt.length);
        byte[] sha512MatchBytes = new byte[64];
        sha512Match.doFinal(sha512MatchBytes, 0);

        String hexMatch = bytesToHex(sha512MatchBytes);
    ...
    public static byte[] startSha512File(byte[] userInputFile, byte[] userOutputFile, String userInputHash) {
        HashSha512 worker = new HashSha512();
    ...
    public byte[] getFile(byte[] userInputFile) {
        SHA512Digest sha512 = new SHA512Digest();
        sha512.update(userInputFile, 0, userInputFile.length);
        byte[] sha512Bytes = new byte[64];
        sha512.doFinal(sha512Bytes, 0);
    ...
    public byte[] matchFile(byte[] userOutputFile, String userInputHash) {
        ...
        SHA512Digest sha512Match = new SHA512Digest();
        sha512Match.update(userOutputFileByte, 0, userOutputFileByte.length);
        byte[] sha512MatchBytes = new byte[64];
        sha512Match.doFinal(sha512MatchBytes, 0);
