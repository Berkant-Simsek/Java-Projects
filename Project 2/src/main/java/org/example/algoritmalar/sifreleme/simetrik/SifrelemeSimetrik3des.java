...
public class SifrelemeSimetrik3des extends SifrelemeSimetrik{

    public static String start3desMessage(String userInputEncrypt, String userInputDecrypt, String userInputKey) {
        SifrelemeSimetrik3des worker = new SifrelemeSimetrik3des();
    ...
    public String getMessage(String userInputEncrypt) {
        ...
        return "3DES ile metin şifrelendi! " + hexEncrypted;
    }
    ...
    public String generateKeysMessage() {
        ...
        try {
            generator = KeyGenerator.getInstance("DESede", "BC");
        ...
        return "3DES ile anahtar oluşturuldu! " + hexKey;
    }
    ...
    public String solveMessage(String userInputDecrypt, String userInputKey) {
        ...
        if (inputBytesKey.length != 24) {
            throw new IllegalArgumentException("3DES anahtarı 24 bayt olmalı, ama " + inputBytesKey.length + " bayt alındı");
        }
    ...
    public static byte[] start3desFile(byte[] userInputFile, byte[] userOutputFile, String userInputKey) {
        SifrelemeSimetrik3des worker = new SifrelemeSimetrik3des();
